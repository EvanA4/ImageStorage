...
export async function getImages(req: Request, res: Response) {
    try {
        ...
        res.send({
            error: true,
            message:
                err.message != undefined ? err.message : "Failed to fetch image.",
            value: undefined,
        });
    }
};
...
export async function postImage(req: Request, res: Response) {
    try {
        ...
        res.send({
            error: true,
            message:
                err.message != undefined ? err.message : "Failed to upload image.",
            value: undefined,
        });
    }
};
...
export async function deleteImage(req: Request, res: Response) {
    try {
        ...
        res.send({
            error: true,
            message:
                err.message != undefined ? err.message : "Failed to delete image.",
            value: undefined,
        });
    }
};